...
describe AgingWorkBarChart do
  context 'pick_colors_for_statuses' do
    let(:status_story_ready) { Status.new name: 'ready', id: 0, type: 'story', category_name: 'To Do', category_id: 0 }
    let(:status_task_ready)  { Status.new name: 'ready', id: 0, type: 'task', category_name: 'To Do', category_id: 0 }
    let(:status_task_ready_done) { Status.new name: 'ready', id: 0, type: 'task', category_name: 'Done', category_id: 0 }
    ...
    it 'should handle the In Progress category' do
      status = Status.new name: 'ready', id: 0, type: 'story', category_name: 'In Progress', category_id: 0
      chart = AgingWorkBarChart.new
    ...
    it 'should raise exception for unknown status category' do
      status = Status.new name: 'ready', id: 0, type: 'story', category_name: 'Unknown', category_id: 0
      chart = AgingWorkBarChart.new
      chart.possible_statuses = [status]
