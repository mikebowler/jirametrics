...
class TestableChart < ChartBase
  attr_accessor :issues, :cycletime, :board_metadata, :date_range
  def run
    'running'
  end
end
...
describe HtmlReportConfig do
  ...
  it 'should inject issues' do
    ...
    expect(chart.date_range).to eq DateTime.parse('2021-09-14')..DateTime.parse('2021-12-13T23:59:59+00:00')
