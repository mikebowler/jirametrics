...
describe Anonymizer do
  ...
  context 'anonymize_issue_keys_and_titles' do
    ...
    it 'clears description change text in change history' do
      issue = anonymizer.project_config.issues.first
      change = ChangeItem.new(
        raw: { 'field' => 'description', 'to' => nil, 'toString' => 'New secret text', 'from' => nil, 'fromString' => 'Old secret text' },
        time: to_time('2021-07-01'), author_raw: nil, artificial: true
      )
      issue.changes << change
      anonymizer.anonymize_issue_keys_and_titles(issues: [issue])
  ...
  context 'anonymize_sprints' do
    ...
    it 'anonymizes sprint names' do
      board.sprints << Sprint.new(raw: { 'id' => 1, 'state' => 'closed', 'name' => 'Sprint Alpha', 'activatedDate' => '2021-06-01T00:00:00.000Z', 'endDate' => '2021-06-15T00:00:00.000Z', 'completeDate' => '2021-06-15T00:00:00.000Z' }, timezone_offset: '+00:00')
      board.sprints << Sprint.new(raw: { 'id' => 2, 'state' => 'active', 'name' => 'Sprint Beta', 'activatedDate' => '2021-06-16T00:00:00.000Z', 'endDate' => '2021-06-30T00:00:00.000Z' }, timezone_offset: '+00:00')
    ...
    it 'assigns the same anonymized name to sprints with the same original name' do
      board.sprints << Sprint.new(raw: { 'id' => 1, 'state' => 'active', 'name' => 'Sprint Alpha', 'activatedDate' => '2021-06-01T00:00:00.000Z', 'endDate' => '2021-06-15T00:00:00.000Z' }, timezone_offset: '+00:00')
      board.sprints << Sprint.new(raw: { 'id' => 2, 'state' => 'active', 'name' => 'Sprint Alpha', 'activatedDate' => '2021-06-01T00:00:00.000Z', 'endDate' => '2021-06-15T00:00:00.000Z' }, timezone_offset: '+00:00')
      anonymizer.anonymize_sprints
  ...
  context 'anonymize_fix_versions' do
    it 'anonymizes fix version names consistently across issues' do
      ...
      issue2.raw['fields']['fixVersions'] = [{ 'id' => '10', 'name' => 'v1.0', 'released' => false }, { 'id' => '20', 'name' => 'v2.0', 'released' => false }]
